...
export async function recognizeIngredients(imageBase64: string, apiKey: string): Promise<string> {
...
export async function generateRecipe(ingredients: string, apiKey: string, lang: string = 'zh'): Promise<string> {
